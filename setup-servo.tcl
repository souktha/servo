...
set script_file "setup-servo.tcl"


proc create {} {
cd [pwd]
create_project -force servo -part xc7a100tcsg324-1 
add_files -norecurse {servo_top.v servo.v Nexys4DDR_Master.xdc}
#import_ip -files {ipfile.xci}
import_files -force -norecurse
import_files -fileset sim_1 -norecurse {servo_tb.v}
update_compile_order -fileset sim_1
}

proc run {} {
if [string is alnum [current_project -quiet]] then {open_project .  servo.xpr} else {puts "project is [current_project]"}
...
set_property xsim.view {servo_tb.wcfg} [get_filesets sim_1]
